...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"**Ok** [{name0}](tg://user?id={uid})**Pesan Anda Sudah Di Terima**")
...
async def disapprovepm(disapprvpm):
    ...
    await disapprvpm.edit(
        f" **Maaf** [{name0}](tg://user?id={aname}) **Pesan Anda Sudah Ditolak, Mohon Jangan Melakukan Spam Di Room Chat!**"
    )
